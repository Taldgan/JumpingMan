...
public class GameObject extends InputFunctions{
	...
	//Etc
	Group group = new Group();/* = new Group(theVoid, background, groundSet1, ref.getCharacter(), ref2.getCharacter(), 
	...
	public void initializeLvl()
	{
		...
		mainGuy = new Character(250, 450-25, 20, Color.RED);
		theVoid.setY(-2500);
		theVoid.setX(-2500);
		lvl1Set1 = "0100000110020301030100100000203020010000001";
		lvl1Set2 = "000000002000400000002";
		lvl1Set3 = "0001100";
		lvl1ESet = "03001010300405020501210001000201000222"; //Enemy set
		lvl1GSet1 = "11101001110111111111111111";
		platformSet1 = spawnPlatforms(lvl1Set1,0,0,Color.SADDLEBROWN, Color.GREEN, pList1);
		platformSet2 = spawnPlatforms(lvl1Set2,-50,50, Color.SADDLEBROWN, Color.GREEN, pList2);
		groundSet1 = spawnGround(lvl1GSet1, 0, 0,  Color.SADDLEBROWN, Color.GREEN, gList);
		e1 = spawnEnemies(lvl1ESet);
		group = new Group(theVoid, background, groundSet1, mainGuy.getCharacter(),e1,platformSet1,platformSet2);
		allObs.addAll(gList);
		allObs.addAll(pList1);
		allObs.addAll(pList2);
		allObs.addAll(pList3);
	...
	public void processInput() {
		...
		if (getState() == State.Level1 || getState() == State.Level2 || getState() ==  State.MainMenu) {
